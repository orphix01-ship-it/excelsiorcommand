...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if ((activeLayers as any).chokepoints) {
      loadLayerOnce('chokepoints', '/api/chokepoints', d => ({ chokepoints: d.points }));
    }
        ...
        {showSplash && (
          ...
          >
            ...
            <motion.div
              ...
              className="mb-8 flex items-center justify-center z-[2]"
            >
              <span className="ex-crest" role="img" aria-label="Excelsior" style={{ width: '150px' }} />
            </motion.div>

            {/* ── EXCELSIOR title — letter-by-letter stagger ── */}
            <div className="flex items-center gap-[2px] mb-3 z-[2]">
              {'EXCELSIOR'.split('').map((letter, i) => (
                <motion.span
                  key={i}
